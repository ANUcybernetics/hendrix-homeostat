...
# Set hostname to jimi
config :nerves_runtime, :kernel, hostname: "jimi"
...
config :mdns_lite,
  ...
  # advertises the device's hostname.local (jimi.local in this case).
...
config :hendrix_homeostat, HendrixHomeostatWeb.Endpoint,
  ...
  url: [host: "jimi.local", port: 80, scheme: "http"],
  server: true,
  code_reloader: false,
  check_origin: false,
  secret_key_base:
